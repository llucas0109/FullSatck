...
import { HomeImg,Button,CategoriesMenu,ProductsConteiner,ManegerConteiner,Menu,Location,Container } from './style.js'
...
const Product = () => {
  ...
  return(
    ...
    <Container>
      ...
      <Menu>
        <CategoriesMenu id='gridmenu'>
          {categories && categories.map(category => <Button id={category.id} type='button'
          key={category.id}
